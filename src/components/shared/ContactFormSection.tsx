      ...
      <div className="contact-form-section__inner container">
        <div className="contact-form-section__info">
          ...
          <p className="contact-form-section__sub reveal" data-delay="0.1">
            Our team is happy to answer any questions about the villas, availability,
            pricing, or the IRA Estates experience.
          </p>
          <a
        ...
        <ContactForm sourcePage="Home Contact Section" subject="New Lead — IRA Estates Home Page" />
      </div>
    </section>
  )
}
